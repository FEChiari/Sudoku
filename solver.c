...
/*
   ...
   ========================================================================
*/
u8 loeseSudoku( struct sSudokuField sudokumatrix[ MATRIX_SIZE ][ MATRIX_SIZE ] )
{
  int i, j, k, l;
...
/*
   ...
   ========================================================================
*/
u8 zifferPruefung( struct sSudokuField sudokumatrix[ MATRIX_SIZE ][ MATRIX_SIZE ], u8 x,
  u8 y, u8 iZahl )
{
  int i;
  /*
...
/*
   ...
   ========================================================================
*/
u8 sudokuPruefung( struct sSudokuField sudokumatrix[ MATRIX_SIZE ][ MATRIX_SIZE ] )
{
...
/*
   ...
   ========================================================================
*/
u8 zaehleLeereFelder( struct sSudokuField sudokumatrix[ MATRIX_SIZE ][ MATRIX_SIZE ] )
{
  int i, j;
  int iZaehler = 0;
  for ( i = 0; i < MATRIX_SIZE; i++ )
...
{
  struct sSudokuField backupmatrix[ MATRIX_SIZE ][ MATRIX_SIZE ];
  int i, j;
  ...
  */
  for ( i = 0; i < MATRIX_SIZE; i++ )
  {
    for ( j = 0; j < MATRIX_SIZE; j++ )
    {
      backupmatrix[ i ][ j ].value = sudokumatrix[ i ][ j ].value;
    }
  }
  ...
  */
  if ( loeseSudoku( backupmatrix ) )
  {
    do
    {
      ...
      {
        sudokumatrix[ iZufallx ][ iZufally ].value = backupmatrix[ iZufallx ][ iZufally ].value;
        k = 1;
      }
    }
    while ( k == 0 );
  ...
  */
  ...
  while ( i < MATRIX_SIZE )
  {
    ...
    if ( sudokumatrix[ iZeile ][ iSpalte ].value == 0 )
    {
      ...
      sudokumatrix[ iZeile ][ iSpalte ].type = FIELD_USER_FILLED_IN;
      i++;
    }
  }
